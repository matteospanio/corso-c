...
return function() {
    ...
    1 : [
        ...
        {"./src/Lexer" : 2, "./src/ParseError" : 3, "./src/Parser" : 4, "./src/Renderer" : 5}
    ],
    2 : [
        function(e, t, n) {
            var i = e("./utils");
            ...
            r.prototype._next = function() {
                ...
                for (var o in p)
                {
                    ...
                    var l = a[0];
                    var h = a[1] ? a[1] : l;
                    this._nextAtom = {type : o, text : h, whitespace : e};
                    this._pos += l.length;
    ...
    4 : [
        function(e, t, n) {
            ...
            i.prototype._parseFunction = function() {
                ...
                e.expect("func", `end${t}`);
                var o = new a("function", {type : t, name : n});
                o.addChild(i);
                o.addChild(r);
                return o
            };
            ...
            var u = {
                ...
                "cond-symbol" :
                    {tokenType : "func", tokenValues : [ "and", "or", "not", "true", "false", "to", "downto" ]},
                ...
                "font-dclr" : {
                    tokenType : "func",
                    tokenValues : [
                        "normalfont", "rmfamily", "sffamily", "ttfamily", "upshape", "itshape", "slshape", "scshape",
                ...
                "font-cmd" : {
                    tokenType : "func",
                    tokenValues : [
                        "textnormal", "textrm", "textsf", "texttt", "textup", "textit", "textsl", "textsc", "uppercase",
                        "lowercase", "textbf", "textmd", "textlf"
                    ]
                },
    ...
    5 : [
        function(n, e, t) {
                ...
                while ((t = this._nodes.shift()) !== undefined)
                {
                    ...
                    case "math":
                        ...
                        else if (e.name === "mathjax")
                        {
                            ...
                            {
                                this._html.putHTML(e.driver.tex2chtml(i, {display : false}).outerHTML)
                            }
                        }
                        else
                        {
            ...
            function F(e, t)
            {
                ...
                if (typeof katex !== "undefined")
                {
                    this.backend = { name : "katex", driver : katex }
                }
            ...
            F.prototype._newLine = function() {
                ...
                if (this._blockLevel > 0)
                {
                    ...
                    {
                        this._html.beginSpan("ps-linenum", {left : `${- ((this._blockLevel - 1) * t)}em`})
                ...
                {
                    this._html.beginP("ps-line", {"text-indent" : `${- e}em`, "padding-left" : `${e}em`},
            ...
            F.prototype._buildTree = function(e) {
                ...
                case "command":
                    var k = e.value;
                    var C = {break : "break", continue : "continue"}[k];
                    this._newLine();
                    if (C)
                        this._typeKeyword(C);
                    break;
        ...
        {"./utils" : 6, katex : undefined, mathjax : undefined}
    ],
    6 : [
        function(e, t, n) {
            function i(e)
